...
namespace PortfolioProject
{
    public class PortFolioDBContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Proficiency>().HasData(new Proficiency {ID = 1, name = "HTML",description="Html",} , new Proficiency { ID = 2, name = "CSS", description = "CSS", }, new Proficiency { ID = 1, name = "JavaScript", description = "JavaScript", }, new Proficiency { ID = 1, name = "C#", description = "C#", }, new Proficiency { ID = 1, name = "Bootstrap", description = "Bootstrap", }, new Proficiency { ID = 1, name = "PHP", description = "PHP", });
