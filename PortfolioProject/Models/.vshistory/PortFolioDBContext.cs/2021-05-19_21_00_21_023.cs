...
namespace PortfolioProject
{
    public class PortFolioDBContext:DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            new Project { ID = 2, userID = 1, projectTitle = "GP Calculator Console Application", projectDescription = "Application Calculates Student GP", projectImageUrl = "https://res.cloudinary.com/decagom/image/upload/v1621193621/porfolio/2021-05-11_8_s13r6d.png" });
            ...
            modelBuilder.Entity<Proficiency>().HasData(
                ...
                new Proficiency { ID = 1, name = "Bootstrap", description = "Bootstrap", },
                new Proficiency { ID = 1, name = "JavaScript", description = "JavaScript", },
                new Proficiency { ID = 1, name = "C#", description = "C#", },
                new Proficiency { ID = 1, name = "PHP", description = "PHP", });
        }
